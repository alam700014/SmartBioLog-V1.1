...
//import com.morpho.morphosample.MorphoSample1;
//import com.morpho.morphosample.MorphoSample2;
...
import com.android.fortunaattendancesystem.info.subtype.SecurityOption;
import com.android.fortunaattendancesystem.info.subtype.SensorWindowPosition;
...
public class ProcessInfo {
    ...
    public void setAcplFm220Sdk(acpl_FM220_SDK acpl_fm220_sdk) {
        this.acpl_fm220_sdk = acpl_fm220_sdk;
    }

    private acpl_FM220_SDK acpl_fm220_sdk = null;
    ...
    private int identifyTimeout = 0;
    private int enrollTimeout = 15;
    ...
    private volatile boolean isIdentificationStarted=false;
    private volatile boolean isVerificationStarted=false;
    private volatile boolean reStartIdentification=false;

    public boolean isReStartIdentification() {
        return reStartIdentification;
    }

    public void setReStartIdentification(boolean reStartIdentification) {
        this.reStartIdentification = reStartIdentification;
    }

    public boolean isIdentificationStarted() {
        return isIdentificationStarted;
    }

    public void setIdentificationStarted(boolean identificationStarted) {
        isIdentificationStarted = identificationStarted;
    }

    public boolean isVerificationStarted() {
        return isVerificationStarted;
    }

    public void setVerificationStarted(boolean verificationStarted) {
        isVerificationStarted = verificationStarted;
    }

    private EmployeeFingerEnrollmentActivity viewAllEmployeesActivity = null;
    ...
    public void setEnrollTimeout(int enrollTimeout) {
        this.enrollTimeout = enrollTimeout;
    }

    public int getSensorBus() {
        return sensorBus;
    }

    public void setSensorBus(int sensorBus) {
    ...
    public int getSensorFileDescriptor() {
        return sensorFileDescriptor;
    }

    public void setSensorFileDescriptor(int sensorFileDescriptor) {
        this.sensorFileDescriptor = sensorFileDescriptor;
    }
    ...
    public EmployeeFingerEnrollmentActivity getViewAllEmployeesActivity() {
        return viewAllEmployeesActivity;
    }

    public void setViewAllEmployeesActivity(EmployeeFingerEnrollmentActivity viewAllEmployeesActivity) {
        this.viewAllEmployeesActivity = viewAllEmployeesActivity;
    }
